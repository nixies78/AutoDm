...
### **5. Testing Constraints (Crucial for Workflow Speed)**
* **No Autonomous Testing:** Do not execute test suites, run unit tests, or initiate automated verification scripts unless explicitly requested in the prompt.
* **Assume Success on Execution:** Assume your code updates are structurally sound and let the user handle local runtime verification. 
* **Focus on Code Delivery:** Prioritize fast file modifications and code generation over test-runner execution.
